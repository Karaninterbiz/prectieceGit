namespace LogicalTask_42
{
    ...
    internal class Task_42
    {
        static void Main(string[] args)
        {
            ...
            double minEconomyRate = double.MinValue;

            foreach (var bowler in bowlers)
            {
                if (bowler.Overs >= 2) // Must have bowled at least 2 overs
                {
